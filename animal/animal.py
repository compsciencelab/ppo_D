...
def make_animal_env(log_dir, inference_mode, frame_skip, arenas_dir, info_keywords, reduced_actions, seed, state, rho, phi, record_actions, demo_dir, size_buffer, size_buffer_V):
    ...
    def make_env(rank):
        def _thunk():
            ...
            exe = '/workspace7/Unity3D/gabriele/Animal-AI/models_arenas/AnimalMod_simple_test'
            ...
            if record_actions: 
                ...
                #env = LabAnimalReplayAll(env,arenas_dir,replay_ratio,  demo_dir)
                env = LabAnimalReplayRecord(env,arenas_dir,rho, phi, demo_dir, size_buffer, size_buffer_V)
