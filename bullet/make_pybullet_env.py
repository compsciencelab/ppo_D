...
def make_pybullet_env(env_id, rho=0.1, phi=0.3, demo_dir= '', size_buffer=50, size_buffer_V=50, base_seed=0, log_dir=None, frame_skip=0, frame_stack=1, allow_early_resets=False, info_keywords = ('ereward'), threshold_reward=None):
    ...
    def make_env(rank):
        ...
        def _thunk():
            ...
            env = LabBulletReplayRecord(env,rho, phi, demo_dir, size_buffer, size_buffer_V, threshold_reward)
...
# class LabBulletRestartValue(gym.Wrapper):
#     def __init__(self, env, rho =0.1,size_buffer=100):
...
#         # things needed are the value, frames_left, trajectories, the positions at each time
